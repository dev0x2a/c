...
#line	2	"/home/ryanku/9base/grep/grep.y"
#include	"grep.h"

#line	5	"/home/ryanku/9base/grep/grep.y"
typedef union 
{
	int	val;
	char*	str;
...
#line	115	"/home/ryanku/9base/grep/grep.y"
...
case 1:
#line	22	"/home/ryanku/9base/grep/grep.y"
{
...
case 3:
#line	34	"/home/ryanku/9base/grep/grep.y"
{
		yyval.re = re2or(yypt[-2].yyv.re, yypt[-0].yyv.re);
	} break;
case 5:
#line	40	"/home/ryanku/9base/grep/grep.y"
{ literal = 1; } break;
case 6:
#line	41	"/home/ryanku/9base/grep/grep.y"
{
		yyval.re = yypt[-0].yyv.re;
	} break;
case 8:
#line	48	"/home/ryanku/9base/grep/grep.y"
{
		yyval.re = re2or(yypt[-2].yyv.re, yypt[-0].yyv.re);
	} break;
case 10:
#line	55	"/home/ryanku/9base/grep/grep.y"
{
		yyval.re = re2cat(yypt[-1].yyv.re, yypt[-0].yyv.re);
	} break;
case 12:
#line	62	"/home/ryanku/9base/grep/grep.y"
{
		yyval.re = re2star(yypt[-1].yyv.re);
	} break;
case 13:
#line	66	"/home/ryanku/9base/grep/grep.y"
{
...
case 14:
#line	74	"/home/ryanku/9base/grep/grep.y"
{
		yyval.re.beg = ral(Talt);
		yyval.re.beg->u.alt = yypt[-1].yyv.re.beg;
...
case 15:
#line	83	"/home/ryanku/9base/grep/grep.y"
{
...
case 16:
#line	90	"/home/ryanku/9base/grep/grep.y"
{
		yyval.re.beg = ral(Tbegin);
		yyval.re.end = yyval.re.beg;
	} break;
case 17:
#line	95	"/home/ryanku/9base/grep/grep.y"
{
		yyval.re.beg = ral(Tend);
		yyval.re.end = yyval.re.beg;
	} break;
case 18:
#line	100	"/home/ryanku/9base/grep/grep.y"
{
		yyval.re = re2class("^\n");
	} break;
case 19:
#line	104	"/home/ryanku/9base/grep/grep.y"
{
		yyval.re = re2class(yypt[-0].yyv.str);
	} break;
case 20:
#line	108	"/home/ryanku/9base/grep/grep.y"
{
