...
#line	2	"/home/ryanku/9base/hoc/hoc.y"
#include <u.h>
#include <libc.h>
#include <bio.h>
#include <ctype.h>
...
#line	10	"/home/ryanku/9base/hoc/hoc.y"
typedef union  {
...
#line	138	"/home/ryanku/9base/hoc/hoc.y"
...
case 23:
#line	69	"/home/ryanku/9base/hoc/hoc.y"
{ yyval.inst = yypt[-1].yyv.inst; } break;
case 24:
#line	71	"/home/ryanku/9base/hoc/hoc.y"
{ code(STOP); } break;
case 25:
#line	73	"/home/ryanku/9base/hoc/hoc.y"
{ yyval.inst = code3(whilecode,STOP,STOP); } break;
case 26:
#line	75	"/home/ryanku/9base/hoc/hoc.y"
{ yyval.inst = code(forcode); code3(STOP,STOP,STOP); code(STOP); } break;
case 27:
#line	77	"/home/ryanku/9base/hoc/hoc.y"
{ yyval.inst = code(ifcode); code3(STOP,STOP,STOP); } break;
case 28:
#line	79	"/home/ryanku/9base/hoc/hoc.y"
{ yyval.inst = progp; } break;
case 29:
#line	81	"/home/ryanku/9base/hoc/hoc.y"
{ code(STOP); yyval.inst = progp; } break;
case 30:
#line	83	"/home/ryanku/9base/hoc/hoc.y"
{ yyval.inst = progp; } break;
case 33:
#line	87	"/home/ryanku/9base/hoc/hoc.y"
{ yyval.inst = code2(constpush, (Inst)yypt[-0].yyv.sym); } break;
case 34:
#line	88	"/home/ryanku/9base/hoc/hoc.y"
{ yyval.inst = code3(varpush, (Inst)yypt[-0].yyv.sym, eval); } break;
case 36:
#line	91	"/home/ryanku/9base/hoc/hoc.y"
{ yyval.inst = yypt[-3].yyv.inst; code3(call,(Inst)yypt[-4].yyv.sym,(Inst)(uintptr)yypt[-1].yyv.narg); } break;
case 37:
#line	92	"/home/ryanku/9base/hoc/hoc.y"
{ yyval.inst = code2(varread, (Inst)yypt[-1].yyv.sym); } break;
case 38:
#line	93	"/home/ryanku/9base/hoc/hoc.y"
{ yyval.inst=yypt[-1].yyv.inst; code2(bltin, (Inst)yypt[-3].yyv.sym->u.ptr); } break;
case 39:
#line	94	"/home/ryanku/9base/hoc/hoc.y"
{ yyval.inst = yypt[-1].yyv.inst; } break;
case 40:
#line	95	"/home/ryanku/9base/hoc/hoc.y"
{ code(add); } break;
case 41:
#line	96	"/home/ryanku/9base/hoc/hoc.y"
{ code(sub); } break;
case 42:
#line	97	"/home/ryanku/9base/hoc/hoc.y"
{ code(mul); } break;
case 43:
#line	98	"/home/ryanku/9base/hoc/hoc.y"
{ code(div); } break;
case 44:
#line	99	"/home/ryanku/9base/hoc/hoc.y"
{ code(mod); } break;
case 45:
#line	100	"/home/ryanku/9base/hoc/hoc.y"
{ code (power); } break;
case 46:
#line	101	"/home/ryanku/9base/hoc/hoc.y"
{ yyval.inst=yypt[-0].yyv.inst; code(negate); } break;
case 47:
#line	102	"/home/ryanku/9base/hoc/hoc.y"
{ code(gt); } break;
case 48:
#line	103	"/home/ryanku/9base/hoc/hoc.y"
{ code(ge); } break;
case 49:
#line	104	"/home/ryanku/9base/hoc/hoc.y"
{ code(lt); } break;
case 50:
#line	105	"/home/ryanku/9base/hoc/hoc.y"
{ code(le); } break;
case 51:
#line	106	"/home/ryanku/9base/hoc/hoc.y"
{ code(eq); } break;
case 52:
#line	107	"/home/ryanku/9base/hoc/hoc.y"
{ code(ne); } break;
case 53:
#line	108	"/home/ryanku/9base/hoc/hoc.y"
{ code(and); } break;
case 54:
#line	109	"/home/ryanku/9base/hoc/hoc.y"
{ code(or); } break;
case 55:
#line	110	"/home/ryanku/9base/hoc/hoc.y"
{ yyval.inst = yypt[-0].yyv.inst; code(not); } break;
case 56:
#line	111	"/home/ryanku/9base/hoc/hoc.y"
{ yyval.inst = code2(preinc,(Inst)yypt[-0].yyv.sym); } break;
case 57:
#line	112	"/home/ryanku/9base/hoc/hoc.y"
{ yyval.inst = code2(predec,(Inst)yypt[-0].yyv.sym); } break;
case 58:
#line	113	"/home/ryanku/9base/hoc/hoc.y"
{ yyval.inst = code2(postinc,(Inst)yypt[-1].yyv.sym); } break;
case 59:
#line	114	"/home/ryanku/9base/hoc/hoc.y"
{ yyval.inst = code2(postdec,(Inst)yypt[-1].yyv.sym); } break;
case 60:
#line	116	"/home/ryanku/9base/hoc/hoc.y"
{ code(prexpr); } break;
case 61:
#line	117	"/home/ryanku/9base/hoc/hoc.y"
{ yyval.inst = code2(prstr, (Inst)yypt[-0].yyv.sym); } break;
case 62:
#line	118	"/home/ryanku/9base/hoc/hoc.y"
{ code(prexpr); } break;
case 63:
#line	119	"/home/ryanku/9base/hoc/hoc.y"
{ code2(prstr, (Inst)yypt[-0].yyv.sym); } break;
case 64:
#line	121	"/home/ryanku/9base/hoc/hoc.y"
{ yypt[-0].yyv.sym->type=FUNCTION; indef=1; } break;
case 65:
#line	122	"/home/ryanku/9base/hoc/hoc.y"
{ code(procret); define(yypt[-5].yyv.sym, yypt[-2].yyv.formals); indef=0; } break;
case 66:
#line	123	"/home/ryanku/9base/hoc/hoc.y"
{ yypt[-0].yyv.sym->type=PROCEDURE; indef=1; } break;
case 67:
#line	124	"/home/ryanku/9base/hoc/hoc.y"
{ code(procret); define(yypt[-5].yyv.sym, yypt[-2].yyv.formals); indef=0; } break;
case 68:
#line	126	"/home/ryanku/9base/hoc/hoc.y"
{ yyval.formals = 0; } break;
case 69:
#line	127	"/home/ryanku/9base/hoc/hoc.y"
{ yyval.formals = formallist(yypt[-0].yyv.sym, 0); } break;
case 70:
#line	128	"/home/ryanku/9base/hoc/hoc.y"
{ yyval.formals = formallist(yypt[-2].yyv.sym, yypt[-0].yyv.formals); } break;
case 74:
#line	134	"/home/ryanku/9base/hoc/hoc.y"
{ yyval.narg = 0; } break;
case 75:
#line	135	"/home/ryanku/9base/hoc/hoc.y"
{ yyval.narg = 1; } break;
case 76:
#line	136	"/home/ryanku/9base/hoc/hoc.y"
