...
#define PARIVERSION "GP/PARI CALCULATOR Version 2.10.0 (development)"
#define PARIINFO "amd64 running linux (x86-64/GMP-6.1.1 kernel) 64-bit version"
#define PARI_VERSION_CODE 133632
