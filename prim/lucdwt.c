...
void
fft_real_to_hermitian(double *z, int	n)
{
	...
	register int i1, i2, i3, i4, i5, i6, i7, i8, a, a3, dil;
...
void
fftinv_hermitian_to_real(double *z, int n)
{
	...
	register double *x;
	register int n8, i1, i2, i3, i4, i5, i6, i7, i8, a, a3, dil;
	double e;
	int nn = n>>1, nminus = n-1, is, id;
	int n2, i, j;
...
void
square_hermitian(double *b, int n)
{
...
double addsignal(double *x, int N, int error_log)
{
   	register int k,j,bj,bk,sign_flip,NminusOne = N-1;
...
void
patch(double *x, int N)
{
	register int j,bj,NminusOne = N-1, carry;
...
double
lucas_square(double *x, int N, int error_log)
{
	register int j, *perm;
...
void balancedtostdrep(double *x, int N)
{
...
void
printbits(double *x, int q, int N, int totalbits)
{
