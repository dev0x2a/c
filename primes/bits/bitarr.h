/* IMPORTANT NOTE:
   A version of this code appeared in
   Dr. Dobb's Journal issue #233 (August 1995)
   Volume 20 Issue 8 in an article entitled
   `Implementing Bit Vectors in C' by James Blustein
...
bool ba_diff(bit first[], bit second[], bit *result[], const elem_t size_first,
             const elem_t size_second);
