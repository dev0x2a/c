/* IMPORTANT NOTE: A version of this code appeared in Dr. Dobb's
 * Journal issue #233 (August 1995) Volume 20 Issue 8 in an article entitled
   `Implementing Bit Vectors in C' by James Blustein Pages 42, 44, 46
   (article) and pages 96, 98-100 (code) The code is (c) copyright 1995 by
   Miller Freeman, Inc */
...
bool ba_intersection(
    bit first[], bit second[], bit *result[], const elem_t size_first,
...
unsigned long ba_dotprod(
    const bit first[], const bit second[], const elem_t size_first,
    const elem_t size_second);
