...
/* some default configurations
   ...
   [any size beyond that is ok provided it
   doesn't overflow the data type] */
#ifdef MP_8BIT
...
#define DIGIT_BIT 31
#else
/* default case is 28-bit digits, defines MP_28BIT as handy macro to test */
#define DIGIT_BIT 28
#define MP_28BIT
#endif
#endif
...
/* callback for mp_prime_random, should fill dst with random bytes and
...
/* makes a truly random prime of a given size (bytes)
   ...
   "dat" is a parameter you can have passed to the callback
   (e.g. a state or something) This function doesn't use "dat" 
   itself so it can be NULL
...
/* makes a truly random prime of a given size (bits),
   ...
   doesn't use "dat" itself so it can be NULL */
...
int mp_to_unsigned_bin_n(mp_int *a, unsigned char *b,
