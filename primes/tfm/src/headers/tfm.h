 ...
 * This makes it slower but also timing invariant
...
#if (defined(TFM_X86) || defined(TFM_SSE2) || defined(TFM_ARM) || \
     defined(TFM_PPC32)) && defined(FP_64BIT)
...
/* primality stuff */
/* perform a Miller-Rabin test of
 * a to the base b and store result in "result" */
...
#define fp_prime_random(a, t, size, bbs, cb, dat) \
  fp_prime_random_ex(a, t, ((size)*8)+1, (bbs==1) ? TFM_PRIME_BBS : 0, cb, dat)
