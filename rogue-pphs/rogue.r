.RP
.ds RH A Guide to the Cavern of Cuties
.ds CH
.ds CF - % -
.TL
...
otherwise get lost in the Cavern of Cuties.
.AE
.NH
Introduction
.PP
...
the local guildmasters have sent you into the Cavern of Cuties.  Your
...
allowed to keep all the loot you bring back from the caverns.
.PP
...
with elf-crafted armor and given enough food to reach the caverns.  You
say goodbye to family and friends for what may be the last time and head
up the road.
.PP
You set out on your way to the caverns and after several days of uneventful
travel, you see the ancient ruins that mark the entrance to the Cavern
of Cuties.  It is late at night so you make camp at the entrance and spend
...
as you can, find the Amulet of Yendor, and get out of the Cavern of Cuties
alive.  On the screen, a map of where you have been and what you have seen on
the current cavern level is kept.  As you explore more of the level,
...
other hand generates a new cavern every time you play it and
...
things mean:
.IP Level 8
This number indicates how deep you have gone in the cavern.  It starts
...
Cavern of Cuties.  Watch out, they can be mean.
.NH
Commands
.PP
...
.PP
When you find something in the cavern, it is common to want to pick the
...
Light
.PP
Rooms in the caverns are either lit or dark.  If you walk into a lit room,
...
Armor
.PP
There are various sorts of armor lying around in the cavern.  Some of it
...
displaying the list, then re-displaying the cavern level.
.IP "flush [noflush]"
