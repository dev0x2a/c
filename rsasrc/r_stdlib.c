...
void R_memset(output, value, len) POINTER output; /* output block */
int value;                                        /* value */
...
void R_memcpy(output, input, len) POINTER output; /* output block */
...
int R_memcmp(Block1, Block2, len) POINTER Block1; /* first block */
