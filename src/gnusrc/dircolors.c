...
static const char *const slack_codes[] = {"NORMAL",
                                          "NORM",
                                          "FILE",
                                          "RESET",
                                          "DIR",
...
static void append_quoted(const char *str) {
...
static bool dc_parse_stream(FILE *fp, const char *filename) {
...
static bool dc_parse_file(const char *filename) {
  bool ok;
