...
#define umul_ppmm(ph, pl, m0, m1)                                              \
  do {                                                                         \
    UDItype __m0 = (m0), __m1 = (m1);                                          \
    __asm__("umulh %r1,%2,%0" : "=r"(ph) : "%rJ"(__m0), "rI"(__m1));           \
    (pl) = __m0 * __m1;                                                        \
  } while (0)
#endif
#define UMUL_TIME 18
...
#if !defined(count_leading_zeros) && defined(__GNUC__) &&                      \
...
#endif
#define count_leading_zeros(count, x) ((count) = __MPN(count_leading_zeros)(x))
#endif /* clz using mpn */
#endif /* __alpha */
...
#define UDIV_TIME 220
long __MPN(count_leading_zeros)(UDItype);
#define count_leading_zeros(count, x) ((count) = _leadz((UWtype)(x)))
...
#define umul_ppmm(xh, xl, m0, m1)                                              \
  do {                                                                         \
    ...
    __asm__("multiplu %0,%1,%2" : "=r"(xl) : "r"(__m0), "r"(__m1));            \
    __asm__("multmu %0,%1,%2" : "=r"(xh) : "r"(__m0), "r"(__m1));              \
  } while (0)
#define udiv_qrnnd(q, r, n1, n0, d)                                            \
  __asm__("dividu %0,%3,%4" : "=r"(q), "=q"(r) : "1"(n1), "r"(n0), "r"(d))
#define count_leading_zeros(count, x)                                          \
...
#define add_ssaaaa(sh, sl, ah, al, bh, bl)                                     \
  __asm__("add.f\t%1, %4, %5\n\tadc\t%0, %2, %3"                               \
          : "=r"(sh), "=&r"(sl)                                                \
          : "r"((USItype)(ah)), "rIJ"((USItype)(bh)), "%r"((USItype)(al)),     \
            "rIJ"((USItype)(bl)))
#define sub_ddmmss(sh, sl, ah, al, bh, bl)                                     \
  __asm__("sub.f\t%1, %4, %5\n\tsbc\t%0, %2, %3"                               \
          : "=r"(sh), "=&r"(sl)                                                \
...
#define add_ssaaaa(sh, sl, ah, al, bh, bl)                                     \
  __asm__("adds\t%1, %x4, %5\n\tadc\t%0, %x2, %x3"                             \
          : "=r"(sh), "=&r"(sl)                                                \
          : "rZ"((UDItype)(ah)), "rZ"((UDItype)(bh)), "%r"((UDItype)(al)),     \
...
#define count_leading_zeros(count, x)                                          \
  do {                                                                         \
    ...
    __asm__("ldi		1,%0\n"                                                      \
            ...
            "	extru,tr	%1,15,16,%1	; No.  Shift down, skip "                   \
            "add.\n"                                                           \
            "	ldo		16(%0),%0	; Yes.  Perform add.\n"                           \
            "	extru,=		%1,23,8,%%r0	; Bits 15..8 zero?\n"                      \
            "	extru,tr	%1,23,8,%1	; No.  Shift down, skip "                    \
            "add.\n"                                                           \
            "	ldo		8(%0),%0	; Yes.  Perform add.\n"                            \
            "	extru,=		%1,27,4,%%r0	; Bits 7..4 zero?\n"                       \
            "	extru,tr	%1,27,4,%1	; No.  Shift down, skip "                    \
            "add.\n"                                                           \
            "	ldo		4(%0),%0	; Yes.  Perform add.\n"                            \
            "	extru,=		%1,29,2,%%r0	; Bits 3..2 zero?\n"                       \
            "	extru,tr	%1,29,2,%1	; No.  Shift down, skip "                    \
            "add.\n"                                                           \
...
#define umul_ppmm(xh, xl, m0, m1)                                              \
  do {                                                                         \
    ...
    __asm__("mlr\t%0,%2" : "=r"(__x.__ll) : "%0"(m0), "r"(m1));                \
    (xh) = __x.__i.__h;                                                        \
    (xl) = __x.__i.__l;                                                        \
  } while (0)
#else
#define umul_ppmm(xh, xl, m0, m1)                                              \
  do {                                                                         \
    /* When we have 64-bit regs and gcc is aware of that, we cannot simply use \
       DImode for the product, since that would be allocated to a single       \
       64-bit                                                                  \
       register, whereas mlr uses the low 32-bits of an even-odd register      \
       pair.                                                                   \
    */                                                                         \
    register USItype __r0 __asm__("0");                                        \
    register USItype __r1 __asm__("1") = (m0);                                 \
    __asm__("mlr\t%0,%3" : "=r"(__r0), "=r"(__r1) : "r"(__r1), "r"(m1));       \
    (xh) = __r0;                                                               \
    (xl) = __r1;                                                               \
  } while (0)
#endif /* if 0 */
...
#define udiv_qrnnd(q, r, n1, n0, d)                                            \
  do {                                                                         \
    ...
    __x.__i.__h = n1;                                                          \
    __x.__i.__l = n0;                                                          \
    __asm__("dlr\t%0,%2" : "=r"(__x.__ll) : "0"(__x.__ll), "r"(d));            \
    (q) = __x.__i.__l;                                                         \
    (r) = __x.__i.__h;                                                         \
  } while (0)
#else
...
#define smul_ppmm(xh, xl, m0, m1)                                              \
  do {                                                                         \
    ...
    __asm__("mr\t%0,%2" : "=r"(__x.__ll) : "%0"(m0), "r"(m1));                 \
    (xh) = __x.__i.__h;                                                        \
    (xl) = __x.__i.__l;                                                        \
  } while (0)
/* FIXME: this fails if gcc knows about the 64-bit registers.  */
...
#define add_ssaaaa(sh, sl, ah, al, bh, bl)                                     \
  do {                                                                         \
    __asm__("algr\t%1,%5\n\talcgr\t%0,%3"                                      \
            : "=r"(sh), "=&r"(sl)                                              \
            : "0"((UDItype)(ah)), "r"((UDItype)(bh)), "%1"((UDItype)(al)),     \
...
#define umul_ppmm(xh, xl, m0, m1)                                              \
  do {                                                                         \
    union {                                                                    \
      unsigned int __attribute__((mode(TI))) __ll;                             \
      struct {                                                                 \
        UDItype __h, __l;                                                      \
      } __i;                                                                   \
    } __x;                                                                     \
...
#define count_leading_zeros(cnt, x)                                            \
  do {                                                                         \
    ...
    __asm__("flogr\t%0,%1" : "=r"(__clr_cnt.__ll) : "r"(x)__CLOBBER_CC);       \
...
/* On P6, gcc prior to 3.0 generates a partial register stall for
   ...
   generic x86.  */
    ...
    (HAVE_HOST_CPU_i386 || HAVE_HOST_CPU_i686 || HAVE_HOST_CPU_pentiumpro ||   \
...
#define umul_ppmm(w1, w0, u, v)                                                \
  ({                                                                           \
    ...
    __asm__("emul %2,%1,%0" : "=d"(__x.__ll) : "%dI"(u), "dI"(v));             \
    (w1) = __x.__i.__h;                                                        \
    (w0) = __x.__i.__l;                                                        \
  })
#define __umulsidi3(u, v)                                                      \
...
#define udiv_qrnnd(q, r, nh, nl, d)                                            \
  do {                                                                         \
    ...
    __nn.__i.__h = (nh);                                                       \
    __nn.__i.__l = (nl);                                                       \
    __asm__("ediv %d,%n,%0" : "=d"(__rq.__ll) : "dI"(__nn.__ll), "dI"(d));     \
    (r) = __rq.__i.__l;                                                        \
    (q) = __rq.__i.__h;                                                        \
  } while (0)
#define count_leading_zeros(count, x)                                          \
...
/* The '020, '030, '040 and CPU32 have 32x32->64 and 64/32->32q-32r.  */
    ...
    defined(__mcpu32__) || defined(mcpu32) || defined(__NeXT__)
#define umul_ppmm(w1, w0, u, v)                                                \
...
#define umul_ppmm(xh, xl, a, b)                                                \
  do {                                                                         \
    ...
    __asm__("| Inlined umul_ppmm\n"                                            \
            ...
            : "=&d"(xh), "=&d"(xl), "=d"(__umul_tmp1), "=&d"(__umul_tmp2)      \
...
#if (defined(__mc68020__) || defined(mc68020) || defined(__mc68030__) ||       \
     defined(mc68030) || defined(__mc68040__) || defined(mc68040) ||           \
     defined(__mc68060__) || defined(mc68060) || defined(__NeXT__)) &&         \
    !defined(__mcpu32__)
#define count_leading_zeros(count, x)                                          \
  __asm__("bfffo %1{%b2:%b2},%0" : "=d"(count) : "od"((USItype)(x)), "n"(0))
#define COUNT_LEADING_ZEROS_0 32
#endif
#endif /* mc68000 */
...
#define udiv_qrnnd(q, r, n1, n0, d)                                            \
  ({                                                                           \
    ...
    __x.__i.__h = (n1);                                                        \
    __x.__i.__l = (n0);                                                        \
    __asm__("deid %2,%0" : "=g"(__x.__ll) : "0"(__x.__ll), "g"((USItype)(d))); \
    (r) = __x.__i.__l;                                                         \
    (q) = __x.__i.__h;                                                         \
  })
#define count_trailing_zeros(count, x)                                         \
...
#define add_ssaaaa(sh, sl, ah, al, bh, bl)                                     \
  do {                                                                         \
    if (__builtin_constant_p(bh) && (bh) == 0)                                 \
      __asm__("add%I4c %1,%3,%4\n\taddze %0,%2"                                \
              : "=r"(sh), "=&r"(sl)                                            \
              : "r"((UDItype)(ah)), "%r"((UDItype)(al)), "rI"((UDItype)(bl))); \
  ...
  do {                                                                         \
    if (__builtin_constant_p(bl) && bl > -0x8000 && bl <= 0x8000) {            \
      if (__builtin_constant_p(ah) && (ah) == 0)                               \
        ...
        __asm__("addic %1,%4,%5\n\tsubfe %0,%3,%2"                             \
                : "=r"(sh), "=&r"(sl)                                          \
                : "r"((UDItype)(ah)), "r"((UDItype)(bh)), "rI"((UDItype)(al)), \
                  "*rI"(-((UDItype)(bl))));                                    \
    } else {                                                                   \
      if (__builtin_constant_p(ah) && (ah) == 0)                               \
        __asm__("subf%I3c %1,%4,%3\n\tsubfze %0,%2"                            \
...
#define count_leading_zeros(count, x)                                          \
  do {                                                                         \
    if ((x) >= 0x10000)                                                        \
      __asm__("clz	%0,%1" : "=r"(count) : "r"((USItype)(x) >> 16));       \
    else {                                                                     \
...
#define add_ssaaaa(sh, sl, ah, al, bh, bl)                                     \
  __asm__("addcc	%r4,%5,%1\n"                                                  \
          ...
          : "rJ"((UDItype)(ah)), "rI"((UDItype)(bh)), "%rJ"((UDItype)(al)),    \
            "rI"((UDItype)(bl)), "%rJ"((UDItype)(al) >> 32),                   \
            "rI"((UDItype)(bl) >> 32)__CLOBBER_CC)
#define sub_ddmmss(sh, sl, ah, al, bh, bl)                                     \
  __asm__("subcc	%r4,%5,%1\n"                                                  \
          "	subccc	%r6,%7,%%g0\n"                                              \
          "	subc	%r2,%3,%0"                                                    \
...
#define add_ssaaaa(sh, sl, ah, al, bh, bl)                                     \
  __asm__("addcc	%r4, %5, %1\n"                                                \
          "	addxc	%r2, %r3, %0"                                                \
          : "=r"(sh), "=&r"(sl)                                                \
          : "rJ"((UDItype)(ah)), "rJ"((UDItype)(bh)), "%rJ"((UDItype)(al)),    \
            "rI"((UDItype)(bl))__CLOBBER_CC)
#define umul_ppmm(ph, pl, m0, m1)                                              \
  do {                                                                         \
    UDItype __m0 = (m0), __m1 = (m1);                                          \
    (pl) = __m0 * __m1;                                                        \
    __asm__("umulxhi\t%2, %1, %0" : "=r"(ph) : "%r"(__m0), "r"(__m1));         \
  } while (0)
#define count_leading_zeros(count, x)                                          \
...
#define smul_ppmm(xh, xl, m0, m1)                                              \
  do {                                                                         \
    ...
    USItype __m0 = (m0), __m1 = (m1);                                          \
    __asm__("emul %1,%2,$0,%0" : "=g"(__x.__ll) : "g"(__m0), "g"(__m1));       \
    (xh) = __x.__i.__h;                                                        \
    (xl) = __x.__i.__l;                                                        \
  } while (0)
#define sdiv_qrnnd(q, r, n1, n0, d)                                            \
  do {                                                                         \
    ...
    __x.__i.__h = n1;                                                          \
    __x.__i.__l = n0;                                                          \
    __asm__("ediv %3,%2,%0,%1" : "=g"(q), "=g"(r) : "g"(__x.__ll), "g"(d));    \
  } while (0)
#if 0
...
#define count_trailing_zeros(count, x)                                         \
  do {                                                                         \
    __asm__("ffs 0, 31, %1, %0" : "=g"(count) : "g"((USItype)(x)));            \
  } while (0)
#endif
#endif /* vax */
...
#define udiv_qrnnd(q, r, n1, n0, d)                                            \
  do {                                                                         \
    ...
    (q) = mpn_udiv_qrnnd(&__udiv_qrnnd_r, (UWtype)(n1), (UWtype)(n0),          \
                         (UWtype)d);                                           \
    (r) = __udiv_qrnnd_r;                                                      \
  } while (0)
#endif
