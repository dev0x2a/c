...
enum { FOREGROUND_OPTION = CHAR_MAX + 1, PRESERVE_STATUS_OPTION };
...
static void settimeout(double duration, bool warn) {
...
static bool apply_time_suffix(double *x, char suffix_char) {
  int multiplier;
