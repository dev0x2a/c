...
.even.globl _R_memset

    _R_memset : link a6,
# 0 movel a6 @(16), d1 tstl d1 jeq set1

    movel a6 @(8), a0 moveb a6 @(15), d0
    ...
    : moveb d0,
      ...
      set1 : unlk a6 rts
                 ...
                 .even.globl _R_memcpy

             /*
             Alternative _R_memcpy routine, should work exactly the same as the
             other.
...
# 0 movel a6 @(16),
      ...
      : moveb a0 @(d0
        ...
        a1 @(d0
             : l) addql #1,
        d0 cmpl d0,
        d1 jhi cpy2 cpy1 : unlk a6 rts

                               .even.globl _R_memcmp

                           _R_memcmp : link a6,
# 0 movel d2,
        sp @-tstl a6 @(16) jeq cmp1
...
# 0 movel a6 @(8),
                ...
                digit2
                : tstl a0 @(d0
                            : l : 4) jne digitexit digit1
                  : subql #1,
                    d0 jpl digit2 digitexit
                    : addql #1,
                      d0 unlk a6 rts

                          .even.globl _NN_Decode
...
# 0 moveml #0x3e20,
                      ...
                      d1 subql #1,
                      d1 jmi dec1 dec4
                      : clrl d4 clrl d2 tstl d1 jlt dec2 clrl d3 dec3
                        : moveb a1 @(d1
                                     : l),
                          d3 movel d3,
                          d0 lsll d2,
                          ...
                          d4 subql #1,
                          d1 addql #8,
                          d2 tstl d1 jlt dec2 moveq #31,
                          d6 cmpl d2,
                          d6 jcc dec3 dec2
                          : movel d4,
                            a2 @(a0
                                 : l : 4) addqw #1,
                            a0 tstl d1 jge dec4 jra dec1 dec5
                            : clrl a2 @(a0
                                        : l : 4) addqw #1,
                              a0 dec1
                              : cmpl a0,
                                d5 jhi dec5 moveml a6 @(-24),
# 0x47c unlk a6 rts

                                .even.globl _NN_Encode
...
# 0x3c20,
                                ...
                                : movel a2 @(a0
                                             : l : 4),
                                  d3 clrl d2 tstl d1 jlt enc2 enc3
                                  : movel d3
                                    ,
                                    d0 lsrl d2
                                    ,
                                    ...
                                    : addqw #1,
                                      a0 cmpl a0
                                      ,
                                      d4 jhi enc4 jra enc1 enc5
                                      : clrb a1
                                        @(d1
                                          : l) subql #1,
                                        d1 enc1
                                        : tstl d1 jge enc5 moveml a6 @(-20),
# 0x43c unlk a6 rts

                                          .even.globl _NN_Assign
                                          ...
                                          : movel a0 @(d0
                                            ...
                                            : movel a6 @(-4),
                                              d2 unlk a6 rts
                                                  ...
                                                  .even.globl _NN_AssignZero

                                              _NN_AssignZero : link a6,
# 0 movel d2,
                                              sp @-movel a6 @(12),
                                              d1 tstl d1 jeq ass1

                                              movel a6 @(8),
                                              a0 clrl d0 clrl d2 ass2
                                              : movel d2,
                                                a0 @(d0
                                                     : l : 4) addql #1,
                                                d0 cmpl d0,
