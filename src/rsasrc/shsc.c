...
void SHSInit(context) SHS_CTX *context; /* context */
{
...
void SHSUpdate(context, buffer, count) SHS_CTX *context; /* context */
...
void SHSFinal(digest, context) BYTE *digest;
...
static void byteReverse(buffer, byteCount) UINT4 *buffer;
int byteCount;
{
  UINT4 value;
  int count;
...
static void SHSTransform(context) SHS_CTX *context;
{
  UINT4 W[80], temp;
  int i;
